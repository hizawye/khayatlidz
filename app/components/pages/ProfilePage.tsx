...
export default function ProfilePage() {
    ...
    return (
      <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <h2 className={`text-2xl text-center text-gray-600 ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-7xl mx-auto px-4 py-8" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
        {/* Profile Header */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
            ...
            <div className="md:col-span-9">
              <h1 className={`text-3xl md:text-4xl ${locale === 'ar' ? 'text-right' : 'text-left'} text-brand-600 mb-2 font-bold`}>
                {user.fullName}
              </h1>
              <p className={`text-lg ${locale === 'ar' ? 'text-right' : 'text-left'} text-gray-600 mb-4`}>
                {user.primaryEmailAddress?.emailAddress}
              </p>
              <div className={`flex ${locale === 'ar' ? 'justify-end' : 'justify-start'} gap-3`}>
        ...
        {/* User Posts */}
        <div>
          <h2 className={`text-2xl md:text-3xl ${locale === 'ar' ? 'text-right' : 'text-left'} mb-6 font-bold`}>
            {t('profile.myDesigns')}
          </h2>
